...
public sealed class RegisterRecord { public Guid Id { get; set; } public Guid StoreId { get; set; } public string Name { get; set; } = string.Empty; public bool IsActive { get; set; } public bool CashPaymentEnabled { get; set; } = true; public bool CardPaymentEnabled { get; set; } = true; public bool TransferPaymentEnabled { get; set; } = true; public bool CreditPaymentEnabled { get; set; } = true; public string MercadoPagoTerminalId { get; set; } = string.Empty; public string MercadoPagoTerminalLabel { get; set; } = string.Empty; }
